    ...
    wayland.windowManager.hyprland = {
      settings = {
        ...
        ++ (optionals (!hyprsplit_enabled) (
          mkHyprWorkspaces [ "workspace" "movetoworkspace" "movetoworkspacesilent" ] num
        ))
        ...
        binddl = [
          ...
          ", XF86AudioMicMute, Mute Microphone, exec, ${
            wpctl [
              "set-mute"
        ...
        binddel = [
          # volume
          ", XF86AudioRaiseVolume, Volume Up, exec, ${
            wpctl [
              "set-volume"
              "-l"
              "1.0"
          ...
          ", XF86AudioLowerVolume, Volume Down, exec, ${
            wpctl [
              "set-volume"
              "-l"
              "1.0"
          ...
          "ALT, XF86AudioRaiseVolume, Mic Volume Up, exec, ${
            wpctl [
              "set-volume"
              "-l"
              "1.0"
          ...
          "ALT, XF86AudioLowerVolume, Mic Volume Down, exec, ${
            wpctl [
              "set-volume"
              "-l"
              "1.0"
          ...
          # backlight
          ", XF86MonBrightnessUp, Brightness Up, exec, ${
            brightnessctl [
              "--exponent"
              "s"
              "5%+"
          ...
          ", XF86MonBrightnessDown, Brightness Down, exec, ${
            brightnessctl [
              "--exponent"
              "s"
              "5%-"
          ...
          ", XF86KbdBrightnessUp, Keyboard Brightness Up, exec, ${
            brightnessctl [
          ...
          ", XF86KbdBrightnessDown, Keyboard Brightness Down, exec, ${
            brightnessctl [
              "--device=*::kbd_backlight"
              "s"
              "10%-"
